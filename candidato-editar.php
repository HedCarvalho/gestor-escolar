    ...
    <div class="panel panel-default panel-table">
        ...
        <form class="form-horizontal" name="cadastrarEstudante" method="POST" >
          ...
          <div class="col-sm-12">
			  ...
			  <div class="col-sm-4">
				Número da matricula:
				  <input type="text" class="input-sm form-control" name="biCandidato" value="<?php echo $resultado['numeroBI']?>" placeholder="Número da matricula" required="">
				  <input type="hidden" class="input-sm form-control" name="id" value="<?php echo $resultado['numeroBI']?>" placeholder="Número da matricula" required="">
				</div>
            ...
            <div class="col-sm-12">
								...
								<div class='divH'>
														<div class='alert alert-info text-center' role='alert'>
															...
															<label>Dados da escola anterior</label>
														</div>
							  </div>
